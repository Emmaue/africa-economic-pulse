...
<img src="images/medallion-folder-structure.png" alt="Bronze, Silver, and Gold containers in ADLS Gen2" width="700">
...
<img src="images/rbac-role-assignments.png" alt="RBAC role assignments in Azure IAM" width="700">
...
<img src="images/adf-git-branch-integration.png" alt="ADF Git integration showing branch selector" width="700">
...
<img src="images/adf-linked-services.png" alt="ADF Linked Services list — HTTP and ADLS Gen2" width="700">
...
<img src="images/pipeline-foreach-canvas.png" alt="ADF pipeline canvas showing the ForEach activity wrapping the ingestion pipeline" width="700">
...
<img src="images/bronze-folder-after-run.png" alt="Bronze folder in ADLS after a successful pipeline run" width="700">

**Debug runs, then scheduled trigger:**

<img src="images/pipeline-monitoring-debug-runs.png" alt="Pipeline monitoring view showing debug run history" width="700">

<img src="images/triggered-pipeline-scheduled-run.png" alt="Triggered pipeline run succeeding on schedule" width="700">
...
<img src="images/bronze-notebook-reading-json.png" alt="Databricks notebook reading raw World Bank JSON from Bronze" width="700">
...
<img src="images/silver-transformation-delta-write.png" alt="Databricks notebook writing cleaned data to Silver as Delta tables" width="700">
...
<img src="images/silver-delta-log.png" alt="Silver Delta table transaction log showing partitioned commits by year" width="700">

**Writing Gold aggregates:**

<img src="images/gold-tables-write-notebook.png" alt="Databricks notebook writing Nigeria spotlight and country comparison Gold tables" width="700">

<img src="images/gold-folder-storage-browser.png" alt="Gold folder in ADLS showing written Parquet output" width="700">
...
<img src="images/synapse-external-table-definition.png" alt="CREATE EXTERNAL TABLE SQL script in Synapse" width="700">
...
<img src="images/synapse-cetas-query-result.png" alt="Synapse SQL query result against the economic_summary external table" width="700">
...
<img src="images/powerbi-connect-to-synapse.png" alt="Power BI connecting to Synapse to pull data" width="700">
...
<img src="images/powerbi-data-model-relationships.png" alt="Power BI data model view showing loaded views and fields" width="700">

### Dashboard 1 — African Economic Overview
*How is Africa performing as a continent?*

<img src="images/dashboard-1-continental-overview.jpg" alt="Africa's Economy — Continental Overview dashboard" width="800">
...
<img src="images/dashboard-2-nigeria-spotlight.jpg" alt="Nigeria's Economy trend dashboard" width="800">
...
### Dashboard 3 — Country Comparisons
*How does Nigeria compare to peer African economies?*

Clustered bar (Nigeria vs. top 5 peers), multi-line GDP trends, inflation comparison, a conditionally-formatted country scorecard table, and year/country slicers. *(Screenshot pending — built but not yet captured.)*

Three separate pages were built deliberately to demonstrate analytical breadth — a continental view, a country deep-dive, and a comparative view each answer a different business question, rather than settling for a single beginner-style report page.
...
<img src="images/purview-asset-catalogue.png" alt="Microsoft Purview asset catalogue showing discovered Bronze, Silver, and Gold assets" width="700">

**Registered data sources:**

<img src="images/purview-data-map.png" alt="Purview data map showing registered ADLS Gen2 and Synapse sources" width="500">
...
<img src="images/purview-lineage-status.png" alt="Lineage status details showing an unsupported connector for the copy activity" width="700">
...
<img src="images/committed-notebooks-to-github.png" alt="GitHub repository showing committed ADF pipelines and Databricks notebooks" width="700">
...
**[View the live portfolio →](#)** *(add your portfolio link here)*
